...
import com.example.mvvmdemo.databinding.DialogPositiveAlertBinding
...
class PositiveAlertDialog(
    ...
    private lateinit var binding: DialogPositiveAlertBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DialogPositiveAlertBinding.inflate(layoutInflater)
    ...
    private fun updateDataInUI() {
        binding.apply {
            ...
            tvMessage.text = when (forceLogout) {
                true -> message ?: baseActivity.getString(R.string.force_logout_alert_msg)
                false -> message
            }
        }
    }
